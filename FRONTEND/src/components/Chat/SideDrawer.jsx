...
const SideDrawer = () => {
    ...
    return (
        <>
            ...
            <div
                className={`fixed top-0 left-0 h-full w-80 bg-white/60 backdrop-blur-xl shadow-2xl z-30 transform transition-transform duration-300 ease-in-out border-r border-white/40 ${isDrawerOpen ? "translate-x-0" : "-translate-x-full"
                    }`}
            >
