# 💬 Real-Time MERN Chat Application (PulseChat)
...
A full-stack, real-time messaging application built with the MERN stack (MongoDB, Express.js, React, Node.js). Featuring a modern Glassmorphism UI, this application supports real-time one-on-one messaging, WhatsApp-style double-tick status (`✓✓`), audio notifications & toast alerts, group chats, image sharing, user profile management, and 1-click guest access.
...
- **⚡ Real-Time WebSockets:** Powered by Socket.io for instant message delivery, dynamic typing indicators, and live audio/toast notifications.
- **📱 WhatsApp-Style Experience:** Formatted message timestamps, WhatsApp blue double ticks (`✓✓`), quick Emoji Picker bar (😀, ❤️, 👍, 😂, 🔥), and sidebar conversation previews.
...
- **Routing:** React Router DOM (v6) with Netlify SPA Redirect rules
- **Styling:** Tailwind CSS (Glassmorphism design system)
- **Real-Time Client:** Socket.io-client
- **Audio Chimes:** Web Audio API (`notificationSound.js`)
- **HTTP Client:** Axios
...
VITE_CLOUDINARY_CLOUD_NAME=dmz5pecu0
